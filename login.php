...
<?php if(auth()->guard('user')->check()){ redirect(base_url()); } //no require auth ?>
<?php
//action
if(isset($_POST['login']))
{
    ...
    if( auth()->guard('user')->attempt($username, $password) ) auth()->guard('user')->login($username);
